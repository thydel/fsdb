...
-   [Basics CTE](#basics-cte)
    ...
    -   [hide cols](#hide-cols)
        -   [id hide](#id-hide)
        -   [Example](#example-5)
    -   [Filter on col value](#filter-on-col-value)
        -   [id where](#id-where)
        -   [Example](#example-6)
        -   [id is](#id-is)
        -   [Example](#example-7)
        -   [id like](#id-like)
        -   [Example](#example-8)
    -   [Sum over time bucket](#sum-over-time-bucket)
        -   [id span](#id-span)
        -   [Example](#example-9)
-   [WIP CTE](#wip-cte)
    -   [Volume growth rate over last n time units](#volume-growth-rate-over-last-n-time-units)
        -   [id last](#id-last)
        -   [id growth](#id-growth)
        -   [Example](#example-10)
    -   [Accumlate running value of a column](#accumlate-running-value-of-a-column)
        -   [id chain](#id-chain)
        -   [id acc](#id-acc)
        -   [Example](#example-11)
    -   [Format big numbers](#format-big-numbers)
        -   [id list-int-cols](#id-list-int-cols)
        -   [Example](#example-12)
        -   [id fmt](#id-fmt)
        -   [Example](#example-13)
-   [Combine CTE](#combine-cte)
    -   [Shows latest growth](#shows-latest-growth)
        -   [id latest-growth](#id-latest-growth)
        -   [Example](#example-14)
